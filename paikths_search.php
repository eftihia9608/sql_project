<?php
			...
			<?php
				...
				$sql=	"SELECT *
                        ...
                        OR Θέση LIKE '$something'
                        OR Αριθμός LIKE '$something' 
						OR Επώνυμο LIKE '$something'
						OR Κλεψίματα LIKE '$something'
                        OR Ασίστ LIKE '$something'
                        OR Rebound LIKE '$something' 
						OR Πόντοι LIKE '$something'
						OR Μπλοκ LIKE '$something'
                        OR Χρόνος_που_αγωνίζεται LIKE '$something'
                        OR Βάρος LIKE '$something'
                        OR Ύψος LIKE '$something'";
